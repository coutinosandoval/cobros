...
$("#txtcuenta").autocomplete("reg_update_cuentas.jsp");
    ...
    <body>
        ...
        <form name="FRMefectivo" action="depositosRECIBE.jsp">
         
            <br> Fecha: <input required="true" type="text" name="fecha" class="campofecha" size="12">
         Boleta <input required="true" type="text" name="txtfactura" value="" size="15" />
         <br> Cuenta <input type="text" id="txtcuenta" name="txtcuenta" value="" size="30" />
      
          Cantidad Depositada <input required="true" type="text" name="txtcantidad" value="" size="10" />
