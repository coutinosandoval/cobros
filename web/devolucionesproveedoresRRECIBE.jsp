...
//int filas = datos.acreedoresindividual(descripcioncliente,fechainicial,fechafinal) ;
 int filas = datos.llenatabladevolucionesproveedorestemporal(nombre,fechainicial,fechafinal);
  //filas =1;
 if (filas ==1 )
        {
            response.sendRedirect("devolucionesproveedores.jsp");
    ...
    window.location.href='devolucionesproveedores.jsp';
