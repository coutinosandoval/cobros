...
--%>
<%@page import="pconexion.listamovimientospagosproveedores"%>
...
jQuery(function(){
$("#txtcliente").autocomplete("reg_update_proveedores.jsp");
});
</script>
    ...
    <body>
        ...
        <h1>MOVIEMIENTOS POR PROVEEDOR</h1>
        
        <form name="frmresumenes" action="proveedoresindividualesRECIBE.jsp">
        <%-- 
...
--%>  
   ...
   <%
     //datos.proveedores();
      ...
      LinkedList <listamovimientospagosproveedores> resumenes = datos.listamovimientospagosproveedores(); 
      datos.borratablamovimientospagosproveedor();
