...
<%@page import="groovy.inspect.Inspector.print
(Object[])"%>
...
<html>
    ...
    <body>
        ...
        <%
            ...
            conexion = DriverManager.getConnection("jdbc:mysql://localhost:3306/pvdb", "root", "987565");

  //Cargamos la definicion del reporte *.jasper
  //File reportFile = new File(application.getRealPath("/reportes/recibocliente.jasper"));
            File reportFile = new File(application.getRealPath("/reportes/recibospagos.jasper"));
