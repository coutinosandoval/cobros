...
$("#txtcliente").autocomplete("reg_update_clientes.jsp");
    ...
    <body>
        ...
        <form name="frmresumenes" action="devolucionesclientesRRECIBE.jsp">
        <%-- 
...
--%>  
   ...
   <%
      ...
      LinkedList <listafacturasdevoluciones> resumenes = datos.listafacturasdevoluciones() ; 
...
<table id="mytable" BORDER="1">
  ...
  { 
   ...
   out.println("<td>" + "<a href=devolucionesclientesRECIBE.jsp?factura="+ resumenes.get(i).getfactura() +">"+"Agregar"+"</a>"+"</td>");
