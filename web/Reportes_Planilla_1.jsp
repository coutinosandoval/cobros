...
<html>
    ...
    <body>
      ...
      <% 
          ...
          Connection conexion; Class.forName("com.mysql.jdbc.Driver").newInstance(); conexion = DriverManager.getConnection("jdbc:mysql://localhost:3306/inventario","root","987565");

        
//Cargamos la definicion del reporte *.jasper
//File reportFile = new File(application.getRealPath("/reportes/planilla.jasper"));
