...
--%>
<%@page import="pconexion.listamuestradevolucionesproveedores"%>
...
$("#txtcliente").autocomplete("reg_update_clientes.jsp");
    ...
    <body>
        ...
        <form name="frmresumenes" action="devolucionesproveedoresCIERRA.jsp">
        <%-- 
...
--%>  
   ...
   <%
     ...
     datos.borratablamovimientosdevoluciones();
       LinkedList <listamuestradevolucionesproveedores> resumenes = datos.listamuestradevolucionesproveedores() ; 
...
<table id="mytable" BORDER="1">
  ...
  { 
   ...
   out.println("<td>"+resumenes.get(i).getcompra() +"</td>");
   ...
   out.println("<td>" +
           "<a href=devolucionesproveedoresMuestraRECIBE.jsp?codigo="+ resumenes.get(i).getcodigo()+
           "&factura="+ resumenes.get(i).getfactura() + 
           "> Devolver"+"</a>"+"</td>");
