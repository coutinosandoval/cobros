...
//int filas = datos.acreedoresindividual(descripcioncliente,fechainicial,fechafinal) ;
 ...
 int filas = datos.acreedorindividualspruebas(cliente,fechainicial,fechafinal);
  //filas =1;
 if (filas ==1 )
        
 {
            response.sendRedirect("acreedoresindividuales.jsp");
    ...
    window.location.href='acreedoresindividuales.jsp';
